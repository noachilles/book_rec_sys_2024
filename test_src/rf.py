# RandomForest - Regression Analysis
...
class RFRecommender(BaseRecommender):
    def recommend(self, dataset: Dataset, **kwargs) -> RecommendResult:
        ...
        # 순위 형식의 추천 리스트 작성을 위해 학습용 데이터에 존재하는 모든 사용자와 모든 영화의 조합을 저장한다
        ...
        # 학습용 데이터에 존재하는 
        # 사용자별 평갓값의 최솟값, 최댓값, 평균값,
        # 영화별 평갓값의 최솟값, 최댓값, 평균값을 특징량으로 추가한다
        ...
        # 영화가 특정한 genre에 있는지를 나타태는 특징량을 추가 - boolean 값으로 
