...
class SVDRecommender(BaseRecommender):
    def recommend(self, dataset: Dataset, **kwargs) -> RecommendResult:
        ...
        # 잠재 요인의 개수 정하기(하이퍼 파라미터임)
        factors = kwargs.get("factors", 5)

        # 평갓값을 사용자 x 영화의 행렬로 변환한다. 
        # 사용자-영화 평갓값 행렬 R
